...
Token(type=LIST_START, value='[', position=(32, 18, 4))
Token(type=INTEGER_LITERAL, value='1', position=(32, 19, 4))
Token(type=LIST_END, value=']', position=(32, 20, 4))
...
Token(type=SYMBOL, value='simpleComprehension', position=(35, 1, 0))
Token(type=ASSIGN, value='=', position=(35, 21, 0))
Token(type=LIST_START, value='[', position=(35, 23, 0))
Token(type=SYMBOL, value='x', position=(35, 24, 0))
Token(type=MULTIPLY, value='*', position=(35, 26, 0))
Token(type=INTEGER_LITERAL, value='2', position=(35, 28, 0))
Token(type=FOR, value='for', position=(35, 30, 0))
Token(type=SYMBOL, value='x', position=(35, 34, 0))
Token(type=IN, value='in', position=(35, 36, 0))
Token(type=SYMBOL, value='seq', position=(35, 39, 0))
Token(type=LIST_END, value=']', position=(35, 42, 0))
Token(type=SYMBOL, value='keyValueComprehension', position=(36, 1, 0))
Token(type=ASSIGN, value='=', position=(36, 23, 0))
Token(type=LIST_START, value='[', position=(36, 25, 0))
Token(type=SYMBOL, value='v', position=(36, 26, 0))
Token(type=FOR, value='for', position=(36, 28, 0))
Token(type=SYMBOL, value='k', position=(36, 32, 0))
Token(type=COMMA, value=',', position=(36, 33, 0))
Token(type=SYMBOL, value='v', position=(36, 35, 0))
Token(type=IN, value='in', position=(36, 37, 0))
Token(type=SYMBOL, value='mapItems', position=(36, 40, 0))
Token(type=LIST_END, value=']', position=(36, 48, 0))
Token(type=SYMBOL, value='comprehensionWithCondition', position=(37, 1, 0))
Token(type=ASSIGN, value='=', position=(37, 28, 0))
Token(type=LIST_START, value='[', position=(37, 30, 0))
Token(type=SYMBOL, value='x', position=(37, 31, 0))
Token(type=FOR, value='for', position=(37, 33, 0))
Token(type=SYMBOL, value='x', position=(37, 37, 0))
Token(type=IN, value='in', position=(37, 39, 0))
Token(type=SYMBOL, value='seq', position=(37, 42, 0))
Token(type=IF, value='if', position=(37, 46, 0))
Token(type=SYMBOL, value='x', position=(37, 49, 0))
Token(type=MODULO, value='%', position=(37, 51, 0))
Token(type=INTEGER_LITERAL, value='2', position=(37, 53, 0))
Token(type=EQUAL, value='==', position=(37, 55, 0))
Token(type=INTEGER_LITERAL, value='0', position=(37, 58, 0))
Token(type=LIST_END, value=']', position=(37, 59, 0))
Token(type=SYMBOL, value='multiComprehension', position=(38, 1, 0))
Token(type=ASSIGN, value='=', position=(38, 20, 0))
Token(type=LIST_START, value='[', position=(38, 22, 0))
Token(type=SYMBOL, value='x', position=(39, 5, 4))
Token(type=DOT, value='.', position=(39, 6, 4))
Token(type=SYMBOL, value='name', position=(39, 7, 4))
Token(type=FOR, value='for', position=(40, 5, 4))
Token(type=SYMBOL, value='xs', position=(40, 9, 4))
Token(type=IN, value='in', position=(40, 12, 4))
Token(type=SYMBOL, value='listOfLists', position=(40, 15, 4))
Token(type=IF, value='if', position=(41, 5, 4))
Token(type=SYMBOL, value='xs', position=(41, 8, 4))
Token(type=DOT, value='.', position=(41, 10, 4))
Token(type=SYMBOL, value='length', position=(41, 11, 4))
Token(type=GREATER_THAN, value='>', position=(41, 18, 4))
Token(type=INTEGER_LITERAL, value='2', position=(41, 20, 4))
Token(type=FOR, value='for', position=(42, 5, 4))
Token(type=SYMBOL, value='x', position=(42, 9, 4))
Token(type=IN, value='in', position=(42, 11, 4))
Token(type=SYMBOL, value='xs', position=(42, 14, 4))
Token(type=IF, value='if', position=(43, 5, 4))
Token(type=SYMBOL, value='x', position=(43, 8, 4))
Token(type=DOT, value='.', position=(43, 9, 4))
Token(type=SYMBOL, value='active', position=(43, 10, 4))
Token(type=LIST_END, value=']', position=(44, 1, 0))
Token(type=SYMBOL, value='nestedComprehension', position=(45, 1, 0))
Token(type=ASSIGN, value='=', position=(45, 21, 0))
Token(type=LIST_START, value='[', position=(45, 23, 0))
Token(type=LIST_START, value='[', position=(45, 24, 0))
Token(type=SYMBOL, value='y', position=(45, 25, 0))
Token(type=FOR, value='for', position=(45, 27, 0))
Token(type=SYMBOL, value='y', position=(45, 31, 0))
Token(type=IN, value='in', position=(45, 33, 0))
Token(type=SYMBOL, value='x', position=(45, 36, 0))
Token(type=LIST_END, value=']', position=(45, 37, 0))
Token(type=FOR, value='for', position=(45, 38, 0))
Token(type=SYMBOL, value='x', position=(45, 42, 0))
Token(type=IN, value='in', position=(45, 44, 0))
Token(type=INDEXING_START, value='[', position=(45, 46, 0))
Token(type=LIST_START, value='[', position=(45, 47, 0))
Token(type=INTEGER_LITERAL, value='1', position=(45, 48, 0))
Token(type=COMMA, value=',', position=(45, 49, 0))
Token(type=INTEGER_LITERAL, value='2', position=(45, 51, 0))
Token(type=COMMA, value=',', position=(45, 52, 0))
Token(type=INTEGER_LITERAL, value='3', position=(45, 54, 0))
Token(type=LIST_END, value=']', position=(45, 55, 0))
Token(type=INDEXING_END, value=']', position=(45, 56, 0))
Token(type=LIST_START, value='[', position=(45, 57, 0))
Token(type=INTEGER_LITERAL, value='0', position=(45, 58, 0))
Token(type=LIST_END, value=']', position=(45, 59, 0))
Token(type=IF, value='if', position=(45, 60, 0))
Token(type=SYMBOL, value='x', position=(45, 63, 0))
Token(type=MODULO, value='%', position=(45, 65, 0))
Token(type=INTEGER_LITERAL, value='2', position=(45, 67, 0))
Token(type=EQUAL, value='==', position=(45, 69, 0))
Token(type=INTEGER_LITERAL, value='1', position=(45, 72, 0))
Token(type=LIST_END, value=']', position=(45, 73, 0))
Token(type=EOF, value='', position=(246, 1, 0))
*)
